...
Regarding similarity measurments \ref{ssec:similarity}, we obtain : $$S = \dfrac{1417}{3210} \simeq0.44$$ This tells us that both graphs are not as similar as we could expect (we expected at least a similarity greater than $0.5$) since they are moddeling the same content. 

{\color{red} make a plot with the similarity as a function of the cutoff}

\section{Conclusion}
{\color{red} TODO : (discussion)
  - improving the student experience\\
  - differences btw objective and subjective graph production\\
