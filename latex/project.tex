...
In this paper we will focus on the communities, they are closely related to the strong vertecies since two communities are separated by a strong vertex. They will be computed with the \texttt{Mathematica} function \texttt{FindGraphCommunities}.
